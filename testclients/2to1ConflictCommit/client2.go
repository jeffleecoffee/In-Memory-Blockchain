...
func main() {
	...
	// let client1 commit first

	// delay for 5 second for testing if commit not yet pending
	// fmt.Println("delay for 5 sec")
	// DelayForSec(5)

	// delay for 1 second for testing if commit gets pending very soon
	fmt.Println("delay for 1 sec")
	DelayForSec(1)
